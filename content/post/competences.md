---
title: "Competences"
date: 2026-07-18T15:29:04+02:00
draft: false
tags: ["Compétences"]
---

Mes compétences maîtrisées et en cours d'apprentissage

<!--more-->

## Langages de Programmation, Moteur de Templates, Outils & Logiciels

- **HTML** : Création et structuration de pages web avec un balisage clair et sémantique.
...
- **Windows** : Maîtrise de l'environnement Windows pour une utilisation quotidienne et professionnelle.
...
- **DHCP** : Attribution dynamique des adresses IP pour une gestion réseau optimisée.
- **Apache** : Administration de serveurs web Apache pour héberger des sites et applications.
- **MySQL** : Gestion de bases de données relationnelles pour des applications nécessitant un stockage structuré.
- **MariaDB** : Utilisation de cette base de données pour des solutions performantes et évolutives.
- **Zabbix** : Surveillance et monitoring des infrastructures réseau et systèmes.
- **Wireshark** : Analyse du trafic réseau pour le diagnostic et la résolution de problèmes.
